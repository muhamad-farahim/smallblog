...
<div class="container form__grid">
    ...
    <form class="card rounded form__card" enctype="multipart/form-data" method="POST">
        <h1 class="card-header text-center">CREATE YOUR OWN ARTICLE</h1>
        ...
        <div class="form__inputs w-100">
            ...
            <input type="title" name="title" class="form-control @error('title') is-invalid @enderror" id="ftitle" value="{{ old('title') }}">
            @error('title')
            ...
            <input type="desc" name="desc" class="form-control @error('desc') is-invalid @enderror" id="fdesc" value="{{ old('desc') }}">
            @error('desc')
            ...
            <input tagName value="{{ old('body') }}" id="x" type="hidden" name="body">
